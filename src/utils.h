...
bool procesarEntrada(char *comando, tList *historical, tList *memList, struct dirOps *ops, char *envp[], tList *processList);
...
void customHistoricalPrint(MOD type, char *mod, tList historical, tList memList, struct dirOps *ops, char *envp[], tList *processList);
...
void manageHistoricalWMods(char *mod, tList *historical, tList *memList, struct dirOps *ops, char *envp[], tList *processList);
